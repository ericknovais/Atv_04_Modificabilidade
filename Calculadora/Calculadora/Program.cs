    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (operacao.Contains(rep.Soma))
            {
                ...
                rep.Resultado = $"{rep.Resultado} {Calculadora.Somar(rep.Numero1, rep.Numero2)}";
            }
            else if (operacao.Contains(rep.Sub))
            {
                ...
                rep.Numero1 = Convert.ToInt32(rep.numeros[0]);
                rep.Numero2 = Convert.ToInt32(rep.numeros[1]);
                rep.Resultado = $"{rep.Resultado} {Calculadora.Subtrair(rep.Numero1, rep.Numero2)}";
            }
            else if (operacao.Contains(rep.Div))
            {
                ...
                rep.Numero2 = Convert.ToInt32(rep.numeros[1]);
                rep.Resultado = $"{rep.Resultado} {Calculadora.Dividir(rep.Numero1, rep.Numero2)}";
            }
            else
            {
                ...
                rep.Numero1 = Convert.ToInt32(rep.numeros[0]);
                rep.Numero2 = Convert.ToInt32(rep.numeros[1]);
                rep.Resultado = $"{rep.Resultado} {Calculadora.Multiplicar(rep.Numero1, rep.Numero2)}";
            }
